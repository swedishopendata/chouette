...
@Log4j
public class NoptisImporterInputValidator extends AbstractInputValidator {

	@Override
	public AbstractParameter toActionParameter(String abstractParameter) {
		try {
			return JSONUtil.fromJSON(abstractParameter, NoptisImportParameters.class);
		} catch (Exception e) {
			return null;
		}
	}
	...
	public boolean checkParameters(String abstractParameterString, String validationParametersString) {
		...
		try {
			NoptisImportParameters parameters = JSONUtil.fromJSON(abstractParameterString, NoptisImportParameters.class);
	...
	public boolean checkParameters(AbstractParameter abstractParameter, ValidationParameters validationParameters) {
		if (!(abstractParameter instanceof NoptisImportParameters)) {
			log.error("invalid parameters for noptis import " + abstractParameter.getClass().getName());
			return false;
		}
		return true;
	}
	...
	public static class DefaultFactory extends InputValidatorFactory {
		...
		protected InputValidator create() throws IOException {
			InputValidator result = new NoptisImporterInputValidator();
			return result;
		}
	}

	static {
		InputValidatorFactory.factories.put(NoptisImporterInputValidator.class.getName(), new DefaultFactory());
	}
